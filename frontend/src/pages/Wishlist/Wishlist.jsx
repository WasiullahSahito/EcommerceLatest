...
const Wishlist = () => {
    ...
    const handleAddToCart = (product) => {
        ...
        dispatch(toggleWishlist(product)); // Optional: Remove from wishlist after adding to cart
    };
                            ...
                            <div key={product._id} className="bg-white rounded-lg shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden group">
                                ...
                                <div className="p-4 flex flex-col justify-between" style={{ minHeight: '180px' }}>
                                    ...
                                    <button
                                        ...
                                        className="w-full border border-primeColor text-primeColor py-2 px-4 rounded-md hover:bg-primeColor hover:text-white transition-colors flex items-center justify-center gap-2"
                                    >
