...
//                   <span className="font-bold text-gray-800">Rs. {totalAmt.toFixed(2)}</span>
//                 </p>
//                 <p className="flex justify-between border-b pb-2">
//                   <span className="font-medium text-gray-600">Shipping Charge</span>
//                   <span className="font-bold text-gray-800">Rs. {shippingCharge.toFixed(2)}</span>
//                 </p>
//                 <p className="flex justify-between text-xl">
//                   <span className="font-semibold text-gray-800">Total</span>
//                   <span className="font-extrabold text-primeColor">Rs. {(totalAmt + shippingCharge).toFixed(2)}</span>
//                 </p>
//               </div>
//               <div className="mt-8">
    ...
    <div className="max-w-container mx-auto px-4 pt-10">
      ...
      {products.length > 0 ? (
        ...
        <motion.div
          ...
          animate={{ y: 0, opacity: 1 }}
          transition={{ duration: 0.4 }}
          className="flex flex-col md:flex-row justify-center items-center gap-8 py-20"
        >
          <div>
            <img
          ...
          <div className="max-w-md p-6 bg-white flex flex-col items-center text-center rounded-lg shadow-lg">
            <h1 className="font-titleFont text-xl font-bold uppercase mb-2">
              Your cart feels lonely.
            </h1>
            <p className="text-sm text-gray-600 px-4 mb-6">
              Your Shopping cart lives to serve. Give it purpose — fill it
              with great products and make it happy.
            </p>
            <Link to="/shop">
              <button className="bg-primeColor rounded-md cursor-pointer hover:bg-black active:bg-gray-900 px-8 py-3 font-titleFont font-semibold text-white duration-300">
                Continue Shopping
              </button>
            </Link>
          </div>
