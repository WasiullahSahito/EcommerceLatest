            ...
            <div className="flex space-x-2 overflow-x-auto">
              {productData.images.map((image, index) => (
                <button
                  ...
                  className={`flex-shrink-0 w-20 h-20 rounded-lg overflow-hidden border-2 transition-colors ${selectedImage === index ? 'border-text' : 'border-gray-200'
                    }`}
                >
                  <img
                    src={image}
          ...
          <div className="space-y-6">
                ...
                {["Black", "Brown", "Tan"].map((color) => (
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg border-2 transition-colors ${selectedColor === color
                      ? 'border-primeColor bg-transparent'
            ...
            <div className="space-y-3">
              <button
                ...
                className={`w-full border border-primeColor text-primeColor py-2.5 rounded-lg font-medium transition-colors flex items-center justify-center gap-2 hover:bg-primeColor hover:text-white duration-300 ${!productData.inStock
                    ? 'opacity-50 cursor-not-allowed hover:bg-transparent hover:text-primeColor'
                    : ''
                  }`}
              >
            ...
            <div className="border-t pt-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="flex items-center space-x-3">
                  <Truck className="w-6 h-6 text-primeColor" />
                ...
                <div className="flex items-center space-x-3">
                  <RotateCcw className="w-6 h-6 text-yellow-700" />
              ...
              {['description', 'features', 'specifications', 'reviews'].map((tab) => (
                <button
                  ...
                  className={`py-4 px-1 border-b-2 font-medium text-sm capitalize transition-colors ${activeTab === tab
                    ? 'border-primeColor text-gray-900'
